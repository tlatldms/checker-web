...
export const p6_a2="답2";
export const p6_q3="기존 바코드프린터를 사용하는 사업에서도 쉽게 적용할 수 있나요?";
export const p6_a3="답3";
export const p6_q4="우리 회사에 이 시스템을 사용하려면 별도의 시스템을 구매해야 하나요?";
export const p6_a4="답4";
export const p6_q5="고객 정보 해킹에 대한 위험은 없나요?";
export const p6_a5="답5";
export const p6_q6="정품 인증은 어떻게 해야 하나요?";
export const p6_a6="답6";
export const p6_q7="이 라벨도 복사하면 되는 것 아니에요?";
export const p6_a7="답7";
